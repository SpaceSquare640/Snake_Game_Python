"""UI translations (en / zh_tw / zh_cn) and key-label helper."""
import pygame
...
TRANSLATIONS = {
    "en": {
        ...
        "ai_fill": "AI Fill",
        "ai_astar": "A* Pathfinder",
        "ai_anneal": "Annealing Master",
        "ai_greedy": "Greedy (Easy)",
        "ai_drift": "Drift / Drunk",
        "ai_minimax": "Minimax vs You",
        "ai_minimax_duel": "Minimax Duel",
        "ai_coop_fill": "Co-op Fill",
        "ai_food_rush": "Food Rush",
        "desc_ai_ai": "Shortest-path BFS duel",
        "desc_ai_fill": "Perfect Hamiltonian fill",
        "desc_ai_astar": "A* search + aggression dial",
        "desc_ai_anneal": "Anneals out of dead ends",
        "desc_ai_greedy": "Fast, reckless, dies easily",
        "desc_ai_drift": "Random walk — drunk drift",
        "desc_ai_minimax": "AI predicts & blocks you",
        "desc_ai_minimax_duel": "Hunter vs fleeing runner",
        "desc_ai_coop_fill": "Two snakes fill together",
        "desc_ai_food_rush": "Two snakes race for food",
        ...
        "ready_hint": "or press SPACE",
        "paused": "PAUSED",
        "paused_hint": "Press SPACE / P to resume",
        "resume": "Resume",
    ...
    "zh_tw": {
        ...
        "ai_greedy": "貪婪（簡單）",
        "ai_drift": "漂移／醉酒",
        "ai_minimax": "Minimax 對你",
        "ai_minimax_duel": "Minimax 對決",
        "ai_coop_fill": "協作填滿",
        "ai_food_rush": "搶食競賽",
        "desc_ai_ai": "BFS 最短路徑對決",
        "desc_ai_fill": "完美漢頓循環填滿",
        "desc_ai_astar": "A* 啟發搜尋＋侵略度",
        "desc_ai_anneal": "退火逃出死胡同",
        "desc_ai_greedy": "快但魯莽，容易死",
        "desc_ai_drift": "隨機遊走醉酒漂移",
        "desc_ai_minimax": "AI 預測並封鎖你",
        "desc_ai_minimax_duel": "獵手追殺逃跑者",
        "desc_ai_coop_fill": "兩蛇協作填滿",
        "desc_ai_food_rush": "兩蛇爭奪食物",
    ...
    "zh_cn": {
        ...
        "ai_greedy": "贪婪（简单）",
        "ai_drift": "漂移／醉酒",
        "ai_minimax": "Minimax 对你",
        "ai_minimax_duel": "Minimax 对决",
        "ai_coop_fill": "协作填满",
        "ai_food_rush": "抢食竞赛",
        "desc_ai_ai": "BFS 最短路径对决",
        "desc_ai_fill": "完美哈密顿循环填满",
        "desc_ai_astar": "A* 启发搜索＋侵略度",
        "desc_ai_anneal": "退火逃出死胡同",
        "desc_ai_greedy": "快但鲁莽，容易死",
        "desc_ai_drift": "随机游走醉酒漂移",
        "desc_ai_minimax": "AI 预测并封锁你",
        "desc_ai_minimax_duel": "猎手追杀逃跑者",
        "desc_ai_coop_fill": "两蛇协作填满",
        "desc_ai_food_rush": "两蛇争夺食物",
